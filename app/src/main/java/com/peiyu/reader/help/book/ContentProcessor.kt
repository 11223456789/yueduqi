...
import com.peiyu.reader.constant.AppPattern.spaceRegex
...
import com.peiyu.reader.utils.escapeRegex
            ...
            if (useReplace && book.getUseReplaceRule()) {
                ...
                getContentReplaceRules().forEach { item ->
                    ...
                    try {
                        ...
                        AppLog.put("替换净�? 规则 ${item.name}替换出错.\n${mContent}", e)
                        appCtx.toastOnUi("替换净�? 规则 ${item.name}替换出错")
                    }
                }
            }
        }
