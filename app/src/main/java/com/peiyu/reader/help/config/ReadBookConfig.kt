...
import com.peiyu.reader.utils.getMeanColor
...
import com.peiyu.reader.utils.resizeAndRecycle
...
object ReadBookConfig {
    ...
    data class Config(
        ...
        var bgAlpha: Int = 100,//背景透明�?        var bgType: Int = 0,//白天背景类型 0:颜色, 1:assets图片, 2其它图片
        ...
        var letterSpacing: Float = 0.1f,//字间�?        var lineSpacingExtra: Int = 12,//行间�?        var paragraphSpacing: Int = 2,//段距
        var titleMode: Int = 0,//标题位置 0:居左 1:居中 2:隐藏
        var titleSize: Int = 0,
        var titleTopSpacing: Int = 0,
        var titleBottomSpacing: Int = 0,
        var paragraphIndent: String = "　　",//段落缩进
        var underline: Boolean = false, //下划�?        var paddingBottom: Int = 6,
