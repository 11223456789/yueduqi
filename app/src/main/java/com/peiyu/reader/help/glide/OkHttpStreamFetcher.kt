package com.peiyu.reader.help.glide
...
import com.peiyu.reader.help.http.okHttpClientManga
...
import com.peiyu.reader.utils.isWifiConnect
...
class OkHttpStreamFetcher(
    ...
    override fun loadData(priority: Priority, callback: DataFetcher.DataCallback<in InputStream>) {
        if (failUrl.contains(url.toStringUrl())) {
            callback.onLoadFailed(NoStackTraceException("跳过加载失败的图�?))
            return
        }
