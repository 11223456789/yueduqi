...
import com.peiyu.reader.constant.AppPattern.equalsRegex
...
import com.peiyu.reader.help.http.CookieManager.getCookieNoSession
import com.peiyu.reader.help.http.CookieManager.mergeCookiesToMap
import com.peiyu.reader.help.http.api.CookieManagerInterface
import com.peiyu.reader.utils.NetworkUtils
import com.peiyu.reader.utils.removeCookie

@Keep
object CookieStore : CookieManagerInterface {

    /**
     *保存cookie到数据库，会自动识别url的二级域�?     */
