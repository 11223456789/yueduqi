...
import com.peiyu.reader.ui.book.manga.entities.MangaChapter
import com.peiyu.reader.ui.book.manga.entities.MangaContent
import com.peiyu.reader.ui.book.manga.entities.MangaPage
import com.peiyu.reader.ui.book.manga.entities.ReaderLoading
import com.peiyu.reader.utils.mapIndexed
...
object ReadManga : CoroutineScope by MainScope() {
    ...
    var chapterSize = 0//总章�?    var durChapterPos = 0
    ...
    private suspend fun getManageChapter(chapter: BookChapter, content: String): MangaChapter {
        ...
        if (imageCount == 0 && chapter.isVolume) {
            ...
            pages.addAll(list)
            pages.add(ReaderLoading(chapter.index, imageCount, "已读�?${chapter.title}"))
        }
