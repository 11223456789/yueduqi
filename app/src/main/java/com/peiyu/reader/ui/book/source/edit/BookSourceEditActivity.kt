...
import com.peiyu.reader.databinding.ActivityBookSourceEditBinding
...
import com.peiyu.reader.ui.book.source.debug.BookSourceDebugActivity
import com.peiyu.reader.ui.file.HandleFileContract
import com.peiyu.reader.ui.login.SourceLoginActivity
import com.peiyu.reader.ui.qrcode.QrCodeResult
import com.peiyu.reader.ui.widget.dialog.UrlOptionDialog
import com.peiyu.reader.ui.widget.dialog.VariableDialog
import com.peiyu.reader.ui.widget.keyboard.KeyboardToolPop
import com.peiyu.reader.ui.widget.recycler.NoChildScrollLinearLayoutManager
import com.peiyu.reader.ui.widget.text.EditEntity
...
import com.peiyu.reader.utils.share
import com.peiyu.reader.utils.shareWithQr
...
//        source.ruleReview = reviewRule
    ...
    override fun sendText(text: String) {
        ...
        if (view is EditText) {
            ...
            val edit = view.editableText//获取EditText的文�?            if (start < 0 || start >= edit.length) {
                edit.append(text)
            } else if (start > end) {
                edit.replace(end, start, text)
            } else {
                edit.replace(start, end, text)//光标所在位置插入文�?            }
        }
    }
