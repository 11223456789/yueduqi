package com.peiyu.reader.ui.book.manga.recyclerview
...
import com.peiyu.reader.base.adapter.RecyclerAdapter.Companion.TYPE_FOOTER_VIEW
import com.peiyu.reader.databinding.ItemBookMangaEdgeBinding
import com.peiyu.reader.databinding.ItemBookMangaPageBinding
import com.peiyu.reader.help.glide.progress.ProgressManager
...
import com.peiyu.reader.ui.book.manga.entities.EpaperTransformation
import com.peiyu.reader.ui.book.manga.entities.GrayscaleTransformation
import com.peiyu.reader.ui.book.manga.entities.MangaPage
import com.peiyu.reader.ui.book.manga.entities.ReaderLoading
...
class MangaAdapter(private val context: Context) :
    ...
    //开启灰色图�?    fun enableGray(enable: Boolean) {
