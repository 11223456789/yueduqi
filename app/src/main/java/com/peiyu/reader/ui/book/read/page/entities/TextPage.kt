...
import com.peiyu.reader.ui.book.read.page.entities.TextChapter.Companion.emptyTextChapter
...
import com.peiyu.reader.utils.canvasrecorder.recordIfNeeded
...
data class TextPage(
    ...
    /**
     * 根据行和列返回字符在本页的位�?     * @param lineIndex 字符在第几行
