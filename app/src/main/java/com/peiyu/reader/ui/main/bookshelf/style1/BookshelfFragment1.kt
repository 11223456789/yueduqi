...
package com.peiyu.reader.ui.main.bookshelf.style1
...
class BookshelfFragment1() : BaseBookshelfFragment(R.layout.fragment_bookshelf1),
    ...
    private inner class TabFragmentPageAdapter(fm: FragmentManager) :
        ...
        /**
         * 确定视图位置是否更改时调�?         * @return POSITION_NONE 已更�?刷新视图. POSITION_UNCHANGED 未更�?不刷新视�?         */
        ...
        override fun instantiateItem(container: ViewGroup, position: Int): Any {
            ...
            val group = bookGroups[position]
            /**
             * Activity recreate 会复用之前的 Fragment，不正确的需要重新创�?             */
