...
import com.peiyu.reader.databinding.ActivitySearchContentBinding
...
import com.peiyu.reader.utils.applyNavigationBarMargin
...
import com.peiyu.reader.utils.showSoftInput
...
class SearchContentActivity :
    ...
    fun startContentSearch(query: String) {
        // 按章节搜索内�?        if (query.isBlank()) return
        searchJob?.cancel()
        adapter.clearItems()
