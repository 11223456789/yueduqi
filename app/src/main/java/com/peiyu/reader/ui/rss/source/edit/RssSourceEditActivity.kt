...
import com.peiyu.reader.databinding.ActivityRssSourceEditBinding
...
import com.peiyu.reader.ui.rss.source.debug.RssSourceDebugActivity
        ...
        webViewEntities.apply {
            ...
            add(
                EditEntity(
                    ...
                    "url跳转拦截(js, 返回true拦截,js变量url,可以通过js打开url,比如调用阅读搜索,添加书架�?简化规则写�?不用webView js注入)"
                )
            )
        }
