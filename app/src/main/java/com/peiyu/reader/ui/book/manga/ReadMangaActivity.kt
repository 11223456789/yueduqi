...
import com.peiyu.reader.databinding.ActivityMangaBinding
...
import com.peiyu.reader.ui.book.manga.config.MangaColorFilterConfig
import com.peiyu.reader.ui.book.manga.config.MangaColorFilterDialog
import com.peiyu.reader.ui.book.manga.config.MangaEpaperDialog
import com.peiyu.reader.ui.book.manga.config.MangaFooterConfig
import com.peiyu.reader.ui.book.manga.config.MangaFooterSettingDialog
import com.peiyu.reader.ui.book.manga.entities.BaseMangaPage
import com.peiyu.reader.ui.book.manga.entities.MangaPage
import com.peiyu.reader.ui.book.manga.recyclerview.MangaAdapter
import com.peiyu.reader.ui.book.manga.recyclerview.MangaLayoutManager
import com.peiyu.reader.ui.book.manga.recyclerview.ScrollTimer
import com.peiyu.reader.ui.book.read.MangaMenu
import com.peiyu.reader.ui.book.read.ReadBookActivity.Companion.RESULT_DELETED
...
import com.peiyu.reader.utils.canScroll
import com.peiyu.reader.utils.fastBinarySearch
import com.peiyu.reader.utils.findCenterViewPosition
...
import com.peiyu.reader.utils.toggleSystemBar
...
class ReadMangaActivity : VMBaseActivity<ActivityMangaBinding, ReadMangaViewModel>(),
    ...
    override fun onResume() {
        ...
        networkChangedListener.onNetworkChanged = {
            // 当网络是可用状态且无需初始化时同步进度（初始化中已有同步进度逻辑�?            if (AppConfig.syncBookProgressPlus && NetworkUtils.isAvailable() && !justInitData) {
    ...
    override fun loadFail(msg: String, retry: Boolean) {
        lifecycleScope.launch {
            if (loadingViewVisible) {
                ...
                loadMoreView.error(null, "加载失败，点击重�?)
            }
        }
    }
