...
class DownloadService : BaseService() {
    ...
    private fun startDownload(url: String?, fileName: String?) {
        ...
        kotlin.runCatching {
            ...
            // 设置下载文件保存的路径和文件�?            request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, fileName)
            // 添加一个下载任�?            val downloadId = downloadManager.enqueue(request)
